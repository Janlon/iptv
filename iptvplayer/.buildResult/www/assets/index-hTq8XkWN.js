...
:root {\r
  ...
  color-scheme: dark;\r
  background-color: #000000; /* Fundo completamente preto para modo cinema */\r
  color: #ffffff;\r
}\r
\r
/* Modo Cinema - Fundo escuro total */\r
body.cinema-mode {\r
...
\r
body.cinema-mode * {\r
  --background-primary: #000000;\r
  --background-secondary: #0a0a0a;\r
  --background-card: #111111;\r
  --text-primary: #ffffff;\r
  --text-secondary: #cccccc;\r
  --accent-color: #ff6b35;\r
}\r
\r
* {\r
...
\r
body {\r
  background-color: #000000; /* Preto total para experiência cinema */\r
  min-height: 100vh;\r
  display: flex;\r
  align-items: stretch;\r
  justify-content: center;\r
...
\r
/* Botão Modo Cinema */\r
.dashboard__cinema-btn {\r
  margin-left: 1rem;\r
  padding: 0.75rem 1.75rem;\r
  border-radius: 999px;\r
  border: 1px solid rgba(239, 68, 68, 0.3);\r
  background: linear-gradient(135deg, rgba(239, 68, 68, 0.2), rgba(220, 38, 38, 0.2));\r
  color: rgba(255, 255, 255, 0.9);\r
  font-size: 1rem;\r
  font-weight: 600;\r
  cursor: pointer;\r
...
\r
.dashboard__cinema-btn:hover,\r
.dashboard__cinema-btn:focus-visible {\r
  background: linear-gradient(135deg, rgba(239, 68, 68, 0.3), rgba(220, 38, 38, 0.3));\r
  border-color: rgba(239, 68, 68, 0.5);\r
  transform: translateY(-1px);\r
  outline: none;\r
}\r
\r
.dashboard__cinema-btn--active {\r
  background: linear-gradient(135deg, rgba(239, 68, 68, 0.4), rgba(220, 38, 38, 0.4)) !important;\r
  border-color: rgba(239, 68, 68, 0.8) !important;\r
  box-shadow: 0 0 20px rgba(239, 68, 68, 0.3);\r
...
\r
.cinema-mode .dashboard {\r
  background-color: #000000 !important;\r
}\r
\r
.cinema-mode .dashboard__header {\r
  background: rgba(0, 0, 0, 0.95) !important;\r
  backdrop-filter: blur(10px);\r
  border-bottom: 1px solid rgba(255, 255, 255, 0.1);\r
}\r
\r
.cinema-mode .categories {\r
  background: rgba(0, 0, 0, 0.8) !important;\r
  border-right: 1px solid rgba(255, 255, 255, 0.1);\r
}\r
\r
.cinema-mode .categories__item {\r
...
\r
.cinema-mode .categories__item--active {\r
  background: rgba(239, 68, 68, 0.2) !important;\r
  border-color: rgba(239, 68, 68, 0.5) !important;\r
  color: #ffffff !important;\r
}\r
\r
.cinema-mode .grid {\r
...
\r
.cinema-mode .card--focused {\r
  border-color: rgba(239, 68, 68, 0.7) !important;\r
  box-shadow: 0 0 30px rgba(239, 68, 68, 0.3) !important;\r
}\r
\r
.cinema-mode .details {\r
  background: rgba(0, 0, 0, 0.8) !important;\r
  border: 1px solid rgba(255, 255, 255, 0.1);\r
}\r
\r
.cinema-mode .details__title {\r
  color: #ffffff !important;\r
}\r
\r
.cinema-mode .details__meta {\r
  color: rgba(255, 255, 255, 0.7) !important;\r
}\r
\r
.cinema-mode .details__description {\r
  color: rgba(255, 255, 255, 0.8) !important;\r
}\r
\r
.cinema-mode .details__play {\r
  background: linear-gradient(90deg, #ef4444, #dc2626) !important;\r
  border: 1px solid rgba(239, 68, 68, 0.5);\r
  box-shadow: 0 0 20px rgba(239, 68, 68, 0.3);\r
}\r
\r
.cinema-mode .details__play:hover {\r
  background: linear-gradient(90deg, #dc2626, #b91c1c) !important;\r
  box-shadow: 0 0 30px rgba(239, 68, 68, 0.4);\r
}\r
\r
.cinema-mode .details__favorite {\r
  background: rgba(251, 191, 36, 0.1) !important;\r
  border-color: rgba(251, 191, 36, 0.3) !important;\r
  color: #fbbf24 !important;\r
}\r
\r
/* Efeito de tela de cinema */\r
.cinema-mode::before {\r
  content: '';\r
  position: fixed;\r
  top: 0;\r
  left: 0;\r
  ...
  bottom: 0;\r
  background: \r
    linear-gradient(180deg, rgba(0,0,0,0.3) 0%, transparent 5%, transparent 95%, rgba(0,0,0,0.3) 100%),\r
    linear-gradient(90deg, rgba(0,0,0,0.2) 0%, transparent 3%, transparent 97%, rgba(0,0,0,0.2) 100%);\r
  pointer-events: none;\r
  z-index: 1000;\r
}\r
\r
/* Escurecimento de bordas para efeito cinema */\r
.cinema-mode .dashboard::after {\r
  content: '';\r
  position: absolute;\r
  top: 0;\r
  left: 0;\r
...
/*$vite$:1*/`;
  ...
  const STORAGE_KEY$1 = "gatoflix.credentials";
  ...
  function getProxyTemplate() {
    var _a2;
    const fromImportMeta = typeof { url: _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("assets/index-hTq8XkWN.js", document.baseURI).href } !== "undefined" ? "http://localhost:8787/proxy?url=" : void 0;
  ...
  function LoginScreen() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "login-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-box", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "GatoFlix" }),
  ...
  const KEYCODE_MAP = {
    ...
    // Return
    4: "back",
    // Menu (tratado como back)
    18: "back"
    // Tools (tratado como back)
  };
  ...
  function Dashboard() {
    ...
    const [cinemaMode, setCinemaMode] = reactExports.useState(false);
