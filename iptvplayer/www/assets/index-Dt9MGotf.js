...
/*$vite$:1*/`;
  ...
  function getProxyTemplate() {
    var _a2;
    const fromImportMeta = typeof { url: _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("assets/index-Dt9MGotf.js", document.baseURI).href } !== "undefined" ? "http://localhost:8787/proxy?url=" : void 0;
